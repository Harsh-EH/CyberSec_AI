...
# Load MITRE ATT&CK CTI data
cti_path = r"C:\Users\harsh\OneDrive\Desktop\CyberSec_AI\backend\backend\cti"
try:
    if not os.path.exists(cti_path):
        logger.error(f"[ERROR] MITRE ATT&CK CTI directory not found at {cti_path}")
        mitre_data = None
    else:
